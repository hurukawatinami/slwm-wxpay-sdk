...
public class WXPay {
     ...
     * @param total_fee        订单总金额，传入参数单位为：分
    ...
    public Map<String, String> unifiedOrder(String notify_url, String openid, String body, String out_trade_no, String total_fee,
        ...
        */
        ...
        //微信小程序参数设定
		this.fillRequestData(data);

        // 微信统一下单接口请求地址
        Map<String, String> resultMap = this.unifiedOrder(data);

        WXPayUtil.getLogger().info("订单：" + out_trade_no + " | 【统一下单（wxPay.unifiedOrder）】结果：" + resultMap);
     ...
     * @param total_fee      订单总金额，传入参数单位为：分
     * @param refund_fee     退款总金额，订单总金额，传入参数单位为：分
