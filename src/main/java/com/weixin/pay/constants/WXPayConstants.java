...
public class WXPayConstants {
     ...
     * 公众号、小程序appid
     */
    public static String APP_ID = "wxe57839b3f14a147d"; // 真实
    public static String APP_ID_XXX = "xxx"; // 测试/第二个账号

    /**
     * AppSecret
     */
    public static String SECRET = "cf14819a3929263563d4405b3234c491"; // 真实
    public static String SECRET_XXX = "xxx"; // 测试/第二个账号

    /**
     * 商户号
     */
    public static final String MCH_ID = "1563632991"; // 真实
     ...
     * API密钥，在商户平台设置
     */
    public static final String API_KEY = "iy7823rhiIYEWEy8fwefw9e8iejfkwef"; // 真实
     ...
     * 证书路径
     */
    public static String APICLIENT_CERT = "/services/WXCertUtil/cert/apiclient_cert.p12"; // 真实
    public static String APICLIENT_CERT_XXX = "/services/WXCertUtil/cert/apiclient_cert.p12"; // 真实
